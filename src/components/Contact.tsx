...
const Contact = () => {
  ...
  const { hasCopied, onCopy } = useClipboard("franzleservices@gmail.com");
  const {
    register,
    handleSubmit,
    formState: { errors },
  ...
  const onSubmit = (data: FieldValues) => {
    ...
    emailjs
      .send("service_z6qy6g9", "template_c5xvp8a", data, "RsKhBNky4kZsU_o4X")
      .then(
        () => {
          setFlag.off();
          onOpen();
                ...
                <VStack spacing={5}>
                  <FormControl isRequired>
                    ...
                    {errors.name?.type === "required" && (
                      <Text fontSize="sm" paddingTop={1} color="red.400">
                        Name is required.
                      </Text>
                    )}
                  </FormControl>
